...
lg:px-[50px]
        ...
        `,id:`${l?"open-list":""}`,children:g.map(($,b)=>e.jsx("div",{className:"drop-down-item",children:$},b))})]})}const z=({filteredData:g,boxId:h,checkboxContent:l})=>e.jsx(e.Fragment,{children:l&&l.map((u,x)=>e.jsx("div",{className:`drop-down-item ${h}`,children:u},x))});function Z({data:g,redirectData:h,areaOfStudy:l,programOptionsClean:u,additionalOptions:x}){const b=g.programs.nodes.concat(h.programRedirects.nodes.map(t=>({program:t.redirectProgram,title:t.title}))),[v,N]=a.useState(!1),[p,k]=a.useState(b),[o,C]=a.useState([]),[i,T]=a.useState([]),[c,S]=a.useState([]),[r,w]=a.useState(""),[y,O]=a.useState(null),[m,P]=a.useState(""),D=a.useRef(null),F=t=>{O(y===t?null:t),N(!0)},A=t=>{if(t.type==="click"&&D.current&&!D.current.contains(t.target)||t.type==="keydown"&&t.key==="Escape"){O(null);const s=document.getElementById("open-list");s&&s.removeAttribute("id")}};a.useEffect(()=>(document.addEventListener("click",A),document.addEventListener("keydown",A),()=>{document.removeEventListener("click",A),document.removeEventListener("keydown",A)}),[]),a.useEffect(()=>{V()},[o,i,c,r]);const V=()=>{let t=b.filter(M);o.length>0&&(t=t.filter(U)),i.length>0&&(t=t.filter(X)),c.length>0&&(t=t.filter(Y)),t=t.sort((s,d)=>s.title.localeCompare(d.title)),k(t)},M=t=>{const s=r.toLowerCase(),d=Array.isArray(t.program.school)?t.program.school:[t.program.school];return t.title.toLowerCase().includes(s)||d.some(n=>n.toString().toLowerCase().includes(s))},U=t=>{const s=Array.isArray(t.program.school)?t.program.school:[t.program.school];return o.some(d=>s.includes(d))},X=t=>i.some(s=>(t.program.programOptions??[]).includes(s)),Y=t=>c.some(s=>(t.program.additionalOptions??[]).includes(s)),I=t=>E(t.target.value,C,o),R=t=>E(t.target.value,T,i),H=t=>E(t.target.value,S,c),E=(t,s,d)=>{let n=[...d];n.includes(t)?n=n.filter(L=>L!==t):n.push(t),s(n)},_=t=>{w(t.target.value),N(!0)},G=()=>{w("");const t=document.getElementById("text-filter");t&&(t.value="")},j=(t,s,d)=>t.map((n,L)=>e.jsxs("p",{className:`${s.name}-filter input-container 
        ...
        lg:px-[50px]`,onChange:_,placeholder:"Search by keyword"}),e.jsxs("div",{ref:D,id:"filter-wrapper",className:`flex flex-col gap-[20px] sm:gap-[30px] 
          ...
          `,children:[e.jsx("div",{id:"left-content",className:"flex flex-row flex-wrap  gap-[10px]",children:e.jsxs("div",{className:"relative z-10 filtered-display-box",children:[e.jsx("p",{className:`
              ...
              sm:pt-0
              sm:basis-auto
              sm:text-[17px] `,children:"Filtered by:"}),!r&&o.length==0&&i.length==0&&c.length==0&&e.jsx("div",{className:"drop-down-item",children:e.jsx("p",{id:"all-text-filter",children:"All"})}),r&&e.jsx("div",{className:"drop-down-item",children:e.jsxs("p",{id:"search-text-filter",onClick:G,children:[r,e.jsx("img",{className:"close-button",alt:"close",src:"/close-item.svg"})]})}),e.jsx(z,{boxId:"area-of-study",checkboxContent:j(o,I,o)}),e.jsx(z,{boxId:"degree",checkboxContent:j(i,R,i)}),e.jsx(z,{boxId:"options",checkboxContent:j(c,H,c)})]})}),e.jsxs("div",{id:"right-content",className:`flex flex-row sm:h-[50px] items-center 
     
            `,children:[e.jsxs("p",{className:`font-opensans font-normal text-[14px] leading-[26px]
                   pt-[40px]
                   pb-[20px]
                   sm:pb-0
            sm:pt-0`,children:["Displaying ",e.jsxs("strong",{children:[p.length," results"]})]}),e.jsx(f.img,{src:"/grid-icon.svg",alt:"Grid View",className:"hidden md:block h-[20px] w-auto ml-[25px] cursor-pointer",onClick:()=>P(""),whileHover:{scale:1.025,opacity:1},whileTap:{scale:.9},animate:{opacity:m!="list"?1:.5}}),e.jsx(f.img,{src:"/list-icon.svg",alt:"List View",className:"hidden md:block h-[20px] w-auto ml-[5px] cursor-pointer",onClick:()=>P("list"),whileHover:{scale:1.025,opacity:1},whileTap:{scale:.9},animate:{opacity:m==="list"?1:.5}})]})]})]}),p&&p.length===0&&e.jsxs("div",{id:"no-results",className:`bg-lightgrey max-w-[1128px] 
          p-[40px] mx-[30px]  
          mt-0
          sm:mt-[50px]
          lg:mx-auto

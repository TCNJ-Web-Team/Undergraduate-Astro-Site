import{j as e}from"./jsx-runtime.C3nPk8XT.js";import{r as a}from"./index.Cq8P9Jm4.js";/* empty css                       */import{m as u}from"./motion.C8JOvv4d.js";const q=({program:m,listType:g,index:l,animationState:h})=>{const[d,$]=a.useState(!1),[f,j]=a.useState(!0),v=d?"active-hover":"",c=g=="list";a.useEffect(()=>{setTimeout(()=>j(!1),1200)});const{slug:N,redirecturl:n,programOptions:k,additionalOptions:i}=m.program,{title:T}=m,r={Major:0,"Major/Specialization":0,Minor:1,Certificate:2,"Three-Year Bachelor's":3,Accelerated:4,"Dual Degree":5,"Teacher Education":6,Undeclared:7,Prelaw:8,Premed:9,"Premed/Prehealth":9};return e.jsx("div",{className:`program-card filter   drop-shadow-none transition-all duration-300 bg-white ${v}
      ${f?"pulse":""}  
...
lg:px-[50px]
        ...
        lg:px-[50px]`,onChange:G,placeholder:"Search by keyword"}),e.jsxs("div",{ref:P,id:"filter-wrapper",className:`flex flex-col gap-[20px] sm:gap-[30px] 
            sm:grid sm:grid-cols-2
            md:flex
            md:gap-[40px] md:flex-row`,children:[e.jsx(A,{checkboxContent:y(l,z,n),title:"Schools",isOpen:b===0,onToggle:()=>F(0),index:0}),e.jsx(A,{checkboxContent:y(h,H,i),title:"Programs",isOpen:b===1,onToggle:()=>F(1),index:1}),e.jsx(A,{checkboxContent:y(d,R,r),title:"Options",isOpen:b===2,onToggle:()=>F(2),index:2})]}),e.jsx("hr",{className:"hidden sm:block border-[#bcbcbc]"})]}),e.jsxs("div",{id:"display-box-wrapper",className:`flex flex-col sm:flex-row justify-between min-h-[50px]
          ...
          `,children:[e.jsx("div",{id:"left-content",className:"flex flex-row flex-wrap  gap-[10px]",children:e.jsxs("div",{className:"relative z-10 filtered-display-box",children:[e.jsx("p",{className:`
              ...
              sm:pt-0
              sm:basis-auto
              sm:text-[17px] `,children:"Filtered by:"}),!p&&n.length==0&&i.length==0&&r.length==0&&e.jsx("div",{className:"drop-down-item",children:e.jsx("p",{id:"all-text-filter",children:"All"})}),p&&e.jsx("div",{className:"drop-down-item",children:e.jsxs("p",{id:"search-text-filter",onClick:U,children:[p,e.jsx("img",{className:"close-button",src:"/close-item.svg"})]})}),e.jsx(L,{boxId:"area-of-study",checkboxContent:y(n,z,n)}),e.jsx(L,{boxId:"degree",checkboxContent:y(i,H,i)}),e.jsx(L,{boxId:"options",checkboxContent:y(r,R,r)})]})}),e.jsxs("div",{id:"right-content",className:`flex flex-row sm:h-[50px] items-center 

...
lg:px-[50px]
        ...
        `,id:`${l?"open-list":""}`,children:p.map((O,h)=>t.jsx("div",{className:"drop-down-item",children:O},h))})]})}const z=({boxId:p,checkboxContent:d})=>t.jsx(t.Fragment,{children:d&&d.map((l,u)=>t.jsx("div",{className:`drop-down-item ${p}`,children:l},u))});function le({data:p,redirectData:d,areaOfStudy:l,programOptionsClean:u,additionalOptions:w,gradCheck:O}){let h,P=!1;O?(P=!0,h=p.graduatePrograms.nodes.concat(d.gradProgramsRedirects.nodes.map(e=>({program:{slug:e.graduateProgramRedirect.redirectUrl,redirecturl:e.graduateProgramRedirect.redirectUrl,programOptions:e.graduateProgramRedirect.programOptions,additionalOptions:e.graduateProgramRedirect.additionalOptions,degreeType:e.graduateProgramRedirect.degreeType,school:e.graduateProgramRedirect.school,keywords:null},title:e.title})))):h=p.programs.nodes.concat(d.programRedirects.nodes.map(e=>({program:e.redirectProgram,title:e.title})));const b=h,y=b.sort((e,r)=>e.title.localeCompare(r.title)).slice(0,12),[j,x]=a.useState(!1),[v,A]=a.useState(!1),[k,m]=a.useState(b),[i,g]=a.useState([]),[n,F]=a.useState([]),[c,T]=a.useState([]),[C,Y]=a.useState(""),[E,H]=a.useState(null),[L,U]=a.useState(""),B=a.useRef(null),D=e=>{H(E===e?null:e),A(!0)},$=e=>{if(e.type==="click"&&B.current&&!B.current.contains(e.target)||e.type==="keydown"&&e.key==="Escape"){H(null);const r=document.getElementById("open-list");r&&r.removeAttribute("id")}},[V,K]=a.useState(!1);a.useEffect(()=>{K(!0),V&&(()=>{try{const s=sessionStorage.getItem("programListScrollY");s!==null&&parseInt(s,10)>100&&x(!0)}catch{}})();let r=!1;const o=()=>{r||(window.requestAnimationFrame(()=>{if(window.scrollY>20)try{sessionStorage.setItem("programListScrollY",window.scrollY.toString())}catch{}window.scrollY>100&&!j&&x(!0),r=!1}),r=!0)};return window.addEventListener("scroll",o,{passive:!0}),()=>{window.removeEventListener("scroll",o)}},[V,j]),a.useEffect(()=>{const e=b.sort((r,o)=>r.title.localeCompare(o.title));m(e)},[]),a.useEffect(()=>(document.addEventListener("click",$),document.addEventListener("keydown",$),()=>{document.removeEventListener("click",$),document.removeEventListener("keydown",$)}),[]),a.useEffect(()=>{J()},[i,n,c,C]);const J=()=>{let e=b.filter(Q);i.length>0&&(e=e.filter(W)),n.length>0&&(e=e.filter(Z)),c.length>0&&(e=e.filter(ee)),e=e.sort((r,o)=>r.title.localeCompare(o.title)),m(e)},Q=e=>{const r=C.toLowerCase(),o=Array.isArray(e.program.school)?e.program.school:[e.program.school],s=e.program.keywords?e.program.keywords.toLowerCase().includes(r):!1;return e.title.toLowerCase().includes(r)||o.some(N=>N.toString().toLowerCase().includes(r))||s},W=e=>{const r=Array.isArray(e.program.school)?e.program.school:[e.program.school];return i.some(o=>r.includes(o))},Z=e=>n.some(r=>(e.program.programOptions??[]).includes(r)),ee=e=>c.some(r=>(e.program.additionalOptions??[]).includes(r)),X=e=>R(e.target.value,g,i),_=e=>R(e.target.value,F,n),q=e=>R(e.target.value,T,c),R=(e,r,o)=>{let s=[...o];s.includes(e)?s=s.filter(N=>N!==e):s.push(e),r(s)},I=()=>{x(!0)},te=e=>{I(),Y(e.target.value),A(!0)},re=()=>{Y("");const e=document.getElementById("text-filter");e&&(e.value="")},S=(e,r,o)=>e.map((s,N)=>t.jsxs("p",{className:`${r.name}-filter input-container 
        ...
        lg:px-[50px]`,onChange:te,onClick:()=>I(),placeholder:"Search by keyword"}),t.jsxs("div",{ref:B,id:"filter-wrapper",className:`flex flex-col gap-[20px] sm:gap-[30px] 
            ...
            md:flex
            md:gap-[40px] md:flex-row`,onClick:()=>I(),children:[t.jsx(M,{checkboxContent:S(l,X,i),title:"Schools",isOpen:E===0,onToggle:()=>D(0),index:0}),t.jsx(M,{checkboxContent:S(u,_,n),title:"Programs",isOpen:E===1,onToggle:()=>D(1),index:1}),t.jsx(M,{checkboxContent:S(w,q,c),title:"Options",isOpen:E===2,onToggle:()=>D(2),index:2})]}),t.jsx("hr",{className:"hidden sm:block border-[#bcbcbc]"})]}),t.jsxs("div",{id:"display-box-wrapper",className:`flex flex-col sm:flex-row justify-between min-h-[50px]
        ...
        md:pb-[100px]
        lg:px-0
        `,initial:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(typeof navigator<"u"?navigator.userAgent:"")?{opacity:1,y:0}:v?{opacity:1,y:0}:{opacity:0,y:5},animate:{opacity:1,y:0},transition:{delay:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(typeof navigator<"u"?navigator.userAgent:"")?0:.15,ease:"easeOut",duration:/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(typeof navigator<"u"?navigator.userAgent:"")?0:.3},children:!j&&y?y.map((e,r)=>t.jsx(G,{program:e,listType:L,index:r,animationState:v,gradCheckCard:P},e.program.slug+r)):k.map((e,r)=>t.jsx(G,{program:e,listType:L,index:r,animationState:v,gradCheckCard:P},e.program.slug+r))})]})}export{le as default};
